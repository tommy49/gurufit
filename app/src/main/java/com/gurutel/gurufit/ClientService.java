...
public class ClientService {
        ...
        public ClientService(final Service service, final Connection connection) {
...
/*
                                    if (!result.hasResolution()) {
                                        GooglePlayServicesUtil.getErrorDialog(result.getErrorCode(), service, 0).show();
                                        return;
                                    }
                                    ...
                                    if (!authInProgress) {
                                        try {
                                            ...
                                            authInProgress = true;
                                            result.startResolutionForResult(service, REQUEST_OAUTH);
